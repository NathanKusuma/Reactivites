        ...
        private readonly IUserAccessor _userAccessor;
            ...
            public async Task<Results<Unit>> Handle(Command request, CancellationToken cancellationToken)
            {
                var activity = await _context.Activities
                    ...
                    .SingleOrDefaultAsync(x=>x.Id == request.Id); //SingleOrDefaultAsync to make sure that no duplicate Id
                ...
                return result ? Results<Unit>.Success(Unit.Value) : Results<Unit>.Failure("Problem to update attendance");
